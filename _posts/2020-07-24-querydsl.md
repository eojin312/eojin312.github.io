...
일단, querydsl을 사용하기 하려면 어떠한 것들을 준비해야하는지 간단히 소개합니다.
...
querydsl을 사용하기 위해서는 spring-boot-starter-data-jpa 외에 별도로 dependency가 필요합니다.
 ...
 - querydsl-apt : Entity class와 대응하는 querydsl에서 사용될 Q로 시작하는 클래스파일을 생성해주는 library라고합니다. 뒤에 설명하겠지만 compile단계에서 QItem.class파일이 자동 생성됩니다.
